...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.carmowallison.voyage.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Desafio 4Quality",
				"Desafio 4Quality.", "Versão 1.0",
				"https://github.com/wallisoncarmo/voyage",
				new Contact("Wallison do Carmo Costa", "https://github.com/wallisoncarmo/voyage", "wallisoncarmo01@gmail.com"),
				null, 
